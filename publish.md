 ...
 * breaking RBI rules
 * attempt to murder
 * unintentional attempt to murder
 * breaking promise, defrauding
 * misinformation
 * defamation in front of CIBIL
 * threats
 * intentional hurt
 ...
 * I am hardworking
   ...
   * first-class mechanical engineering graduate, university topper
   * 95th %ile in NPTEL IIT-M Algorithms and Data Structures test
   * changed career *without formal training*, and exceeded peers (who had traditional 3-4 year college)
...
In either case, it is **crucial** that my CIBIL score is not spoiled.
